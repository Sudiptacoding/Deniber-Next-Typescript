...
const Login = () => {
    ...
    return (
        <div className="max-w-md p-6 mx-auto mt-10 bg-white shadow-lg rounded-3xl">
            {/* Title */}
            <h1 className="mb-2 text-2xl font-extrabold">Login</h1>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center">
                        <input
                            type="checkbox"
                            className="w-4 h-4 checkbox mr-2 border-[#D0D1D4] [--chkbg:theme(colors.primary)] [--chkfg:white] checked:border-primary"

                        />
                        <label className="ml-2 text-sm text-gray-600">Remember me</label>
                    </div>
                    <button className="text-base text-primary ">Forgot Password?</button>
                </div>

                {/* Login Button */}
                <button
                    type="submit"
                    className="w-full px-4 py-2 mb-4 font-extrabold text-white rounded-lg bg-primary">
                    Login
                </button>
            ...
            <p className="text-base text-center text-[#444955]">
                Do not have an account? <Link href='/registration' className="text-primary">Register</Link>
            </p>
