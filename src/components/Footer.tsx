...
const Footer = () => {
    ...
    return (
        <>
            {
                currentPath === '/search-result' || currentPath === '/property-details' ? <div className='py-14 bg-[#22252B]'>
                    <footer className="p-10 px-5 footer text-base-content 2xl:px-80 ">
                        <aside>
                            <div className='flex items-center justify-center w-full md:justify-start'> <img className='w-36' src={logo} alt="logo" /></div>
                            <p className="py-8 text-sm text-gray-500 lg:max-w-xs text-center lg:text-left">OurStudio is a digital agency UI / UX Design and Website Development located in Ohio, United States of America?</p>
                        </aside>
                        <nav>
                            <h6 className="text-xl font-extrabold text-white ">Service</h6>
                            <a className="text-gray-500 link link-hover ">About us</a>
                            <a className="text-gray-500 link link-hover ">About us</a>
                            <a className="text-gray-500 link link-hover ">About us</a>
                            <a className="text-gray-500 link link-hover ">About us</a>
                        </nav>
                        ...
                        <nav>
                            <a href="#" className="text-base font-normal max-lg:text-center text-gray-600 whitespace-nowrap transition-all duration-300 hover:text-yellow-800 focus-within:outline-0 focus-within:text-yellow-800 flex items-center gap-4"><span><MdOutlineLocationOn /></span><span>8819 Ohio St. South Gate, CA 90280</span></a>
                            <a href="#" className="text-base font-normal max-lg:text-center text-gray-600 whitespace-nowrap transition-all duration-300 hover:text-yellow-800 focus-within:outline-0 focus-within:text-yellow-800 flex items-center gap-4"><span><MdOutlineMail /></span><span>Ourstudio@hello.com</span></a>
                            <a href="#" className="text-base font-normal max-lg:text-center text-gray-600 whitespace-nowrap transition-all duration-300 hover:text-yellow-800 focus-within:outline-0 focus-within:text-yellow-800 flex items-center gap-4"><span><MdOutlinePhone /></span><span>+1 386-688-3295</span></a>
                            <h6 className="pt-8 text-xl font-extrabold text-white ">Follow us</h6>
                            <span className='flex gap-2 pt-6'>
                    ...
                    <footer className="w-full p-10 px-5 py-4 mx-auto border-t border-base-300 footer text-base-content 2xl:w-2/3 2xl:px-0">
                        <aside className='flex items-center justify-center w-full text-gray-500'>
                            <p >Copyright © {new Date().getFullYear()} - All right reserved by Sudipta Biswas</p>
                        </aside>
                    </footer>
                    ...
                    <footer className="p-10 px-5 footer text-base-content 2xl:px-80 ">
                        ...
                        <nav>
                            <h6 className=" text-xl text-[#22252B] font-extrabold">Service</h6>
                        ...
                        <nav>
                            ...
                            <a href="#" className="text-base font-normal max-lg:text-center text-gray-600 whitespace-nowrap transition-all duration-300 hover:text-yellow-800 focus-within:outline-0 focus-within:text-yellow-800 flex items-center gap-4"><span><MdOutlineMail /></span><span>Ourstudio@hello.com</span></a>
                            <a href="#" className="text-base font-normal max-lg:text-center text-gray-600 whitespace-nowrap transition-all duration-300 hover:text-yellow-800 focus-within:outline-0 focus-within:text-yellow-800 flex items-center gap-4"><span><MdOutlinePhone /></span><span>+1 386-688-3295</span></a>
                            <h6 className=" text-xl text-[#22252B] font-extrabold pt-8">Follow us</h6>
                            <span className='flex gap-2 pt-6'>
                                <a href="#" className="w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[#33CCFF] hover:bg-gray-900">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                        <g id="Social Media">
